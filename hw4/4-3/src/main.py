...
@app.route("/")
def index():
    with open("/home/judge/hw4/4-3/data/free_space.txt", "r") as f:
        free_space = int(f.read())
    with open("/home/judge/hw4/4-3/data/total_space.txt", "r") as f:
        total_space = int(f.read())
    with open("/home/judge/hw4/4-3/data/boot_time.txt", "r") as f:
